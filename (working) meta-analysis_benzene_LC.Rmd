...
3. do various sensitivity analyses:
  ...
  a). highest vs. lowest
  b). external vs. internal (add descriptors to the tribble dataframe)
...
dat_high <- tribble(~study, ~rr, ~lower_ci, ~upper_ci, ~cases, ~design, ~type,
               "Wong et al. (1987): sporadic exposure", 1.46, 0.86, 2.3, 18, "cohort", "industry-based",
               "Collins et al. (2003): low exposure", 1.1, 0.7, 1.5, 32, "cohort", "industry-based",
               "Sorahan et al. (2005)", 1.19, 1.06, 1.34, 293, "cohort", "industry-based",
               "Hoshuyama et al. (2006)", 1.04, 1.00, 1.08, 11, "cohort", "industry-based",
               "Koh et al. (2011)", 0.35, 0.11, 0.83, 6, "cohort", "industry-based",
               ...
               "Babigumira et al. (2023): low exposure", 1.47, 0.9, 2.4, -9999, "cohort", "industry-based",
               "Wan et al. (2024): low exposure", 1.12, 1.03, 1.21, 12329, "case-control", "population-based",
...
#
meta_dat1 <- metagen(data = dat_high,
                   TE = log(dat_high$rr),
                   studlab = study,
                   sm = "RR",
                   fixed = F, 
...
dat <- tribble(~study, ~rr, ~lower_ci, ~upper_ci, ~cases, ~design, ~type,
               "Wong et al. (1987)_conti_exp", 1.25, 0.91, 1.66, 65, "cohort", "industry-based",
               "Collins et al. (2003)_high_exp", 1.6, 1.2, 2.1, 55, "cohort", "industry-based",
               "Sorahan et al. (2005)_incidence", 1.19, 1.06, 1.34, 293, "cohort", "industry-based",
               "Hoshuyama et al. (2006)", 1.04, 1.00, 1.08, 11, "cohort", "industry-based",
               "Koh et al. (2011)_high_exp", 1.42, 0.52, 3.09, 6, "cohort", "industry-based",
               "Koh et al. (2014)_incidence", 0.73, 0.24, 1.71, 5, "cohort", "industry-based",
               "Linet et al. (2015)", 1.5, 1.2, 1.9, 351, "cohort", "industry-based",
               "Collins et al. (2015)", 1.05, 0.89, 1.24, 146, "cohort", "industry-based",
               "Babigumira et al. (2023)_high_exp", 1.15, 0.61, 2.16, -9999, "cohort", "industry-based",
               "Wan et al. (2024)_high_exp", 1.32, 1.18, 1.48, 12329, "case-control", "population-based",
               # "Mattei et al. (2016)", 0.95, 0.44, 2.04, 129, "case-control", "population-based",
               "McHugh et al. (2010)", 1.13, 0.69, 1.86, 38, "case-control", "population-based",
               "Greenland et al. (1994)", 0.58, 0.31, 1.07, -99999, "case-control", "industry-based")

meta_dat1 <- metagen(data = dat1,
                   TE = log(dat1$rr),
                   studlab = study,
                   sm = "RR",
                   fixed = F, 
                   random = T,
                   method.tau = "REML",
                   lower = log(dat1$lower_ci),
                   upper = log(dat1$upper_ci),
                   hakn = TRUE
                   )
