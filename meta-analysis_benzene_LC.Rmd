...
dat_ever <- tribble(~study, ~year, ~rr, ~lower_ci, ~upper_ci, ~cases, ~design, ~type,  ~comp_grp, ~study_type, ~study_quality, ~exposure_quality, ~region, ~sex, ~smoking,
               ...
               "DeMoulin et al. (2024)", 2024, 1, 0.9, 1.2, 221, "Cohort", "population-based", "internal", "Cohort studies with internal comparison", "High", "High", "Asia", "only male","adjusted",
...
sub_result <- tribble(~sub, ~group, ~rr, ~lower_ci, ~upper_ci,
  ...
  mutate(sub = factor(sub, levels = c(
                                      ...
                                      "Continent")),
         group = case_when(
           sub == "Study design" ~ factor(group, levels = c("Cohort (n=9)", 
                                                            "Cohort studies with external comparison (n=6)", 
                                                            "Cohort studies with internal comparison (n=3)", 
                                                            "Case-control (n=3)", 
                                                            "Industry-based (n=10)", 
                                                            "Population-based (n=2)")),
           sub == "Exposure Level" ~ factor(group, levels = c("Low exposure group", 
                                                              "High exposure group")),
           sub == "Study quality" ~ factor(group, levels = c("High (n=3)", 
                                                             "Moderate (n=8)", 
                                                             "Low (n=1)")),
           sub == "Exposure quality" ~ factor(group, levels = c("High (n=4)", 
                                                                "Moderate (n=4)", 
                                                                "Low (n=4)")),
           sub == "Smoking adjustment" ~ factor(group, levels = c("Adjusted (n=3)", 
                                                                  "Not adjusted (n=9)")),
...
rob_result <- tribble(
  ...
  "DeMoulin et al. (2024)",     3, 2, 4, 2, 2, 2,
